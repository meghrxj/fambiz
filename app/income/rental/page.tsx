...
import { Plus, Building2, Calendar, TrendingUp, Trash2, Edit2, ChevronRight, Receipt, CheckCircle2, Clock } from 'lucide-react';
import { format, addMonths, parseISO } from 'date-fns';
import { cn } from '@/lib/utils';

export default function RentalIncomePage() {
  const { properties, rentalPayments, addProperty, deleteProperty, updateProperty, addRentalPayment, deleteRentalPayment } = useFinanceStore();
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
          <div className="bg-[#141414] border border-white/10 rounded-2xl w-full max-w-md p-8 shadow-2xl">
            ...
            <form onSubmit={handlePaymentSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-medium text-zinc-500 uppercase tracking-wider mb-2">Amount Paid</label>
                  <input 
                    type="number" 
